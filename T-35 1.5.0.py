...
top()
print("GLCOS Launch Version: " + glcos)
...
while(running == True):
  if(opmode == "manual"):
    ...
    if(runningpassword == "take5"):
      top()
      print("T-35 In Startup...")
      shortclock()
      ridecheck1 = input("T-35 been inspected following standared precerdures:")
      ...
      if(ridecheck1 == "y") and (ridecheck2 == "y") and (ridecheck3 == "y") and(ridecheck4 == "y") and (ridecheck5 == "y") and (ridecheck6 == "y"):
        ...
        if(pickstartmode == "2"):
          ...
          while(riderunning == True):
            ...
            while(restraintcheck == True):
              if(music == True):
                ...
                if(musicc == "1"):
                  ...
                  estopeng()
                  break
              riderweight = input("Rider Weight: ")
              top()
              if(riderweight == "4"):
                  estopeng()
                  break
            ...
            if(dispatch1 == "31"):
              pressure = 1
              setpressure = riderweight / 100
              if(pressure == setpressure):
                  pressure = str(pressure)
                  print("Pressure GREEN = " + pressure + " Bar")
                  shortclock()
                  top()
              else:
                  top()
                  ...
                  print("PRESSURE FAILURE = "+ pressure + " Bar")
                  print("Error 400: Launch Pressure Failure")
                  shortclock()
                  shortclock()
                  estopeng()
                  break
        ...
        fh = open('ridestartlog.txt', 'a')
        current_date = datetime.datetime.now()
        fh.write("\n" + 'T-35 Start Failed: ' + str(current_date) + "\n" + "Inspection Status: " + ridecheck1 + ridecheck2 + ridecheck3 + ridecheck4 + ridecheck5 + ridecheck6 + "\n" + "Operator Name: " + opname + "\n")
        fh.close()
        shortclock()
        running = False
